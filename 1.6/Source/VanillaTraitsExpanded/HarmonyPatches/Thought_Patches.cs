...
namespace VanillaTraitsExpanded
{
	...
	public static class MoodOffset_Patch
	{
		public static void Postfix(Thought __instance, ref float __result)
		{
			...
			{
				if (__instance.def == VTEDefOf.AteFineMeal || __instance.def.defName == "VCE_AteFineDessert")
				{
					__result = 0;
				}
				else if (__instance.def == VTEDefOf.AteLavishMeal || __instance.def.defName == "VCE_AteGourmetMeal" || __instance.def.defName == "VCE_AteLavishDessert")
				{
					__result *= 1.5f;
				}
			}
